...
package com.example.customfancontrollerchallenge;
...
public class DialView extends View {
    ...
    /**
     * This constructor is called to supply the attributes and the
     * default style. In this case, this constructor
     * collects the attributes into a typed array and calls init().
     *
    ...
    /**
     * Change the colors if the flag for alternate colors is set.
     *
     * @param flagAltColor
     */
    public void setAltColor(boolean flagAltColor) {
        if (mAltColor != flagAltColor) {
            mAltColor = flagAltColor;
            if (mAltColor) {
                mTextPaint.setColor(Color.RED);
            } else {
                mTextPaint.setColor(Color.BLACK);
