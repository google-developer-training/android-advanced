...
package com.example.customfanchallenge;
...
public class DialView extends View {
    ...
    /**
     * Standard constructor called when this custom view is created from
     * Java code.
     *
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        // Old: mDialPaint.setColor(Color.GRAY);
        // Challenge: Set the paint to the fan off color.
        ...
        setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // Set dial background color to fanOnColor if selection is >= 1.
                if (mActiveSelection >= 1) {
                    // Old: mDialPaint.setColor(Color.GREEN);
                    // Challenge: Set the fan on color.
                    mDialPaint.setColor(mFanOnColor);
                } else {
                    // Old: mDialPaint.setColor(Color.GRAY);
                    // Challenge: Set the fan off color.
                    mDialPaint.setColor(mFanOffColor);
                }
                // Redraw the view.
                invalidate();
